...
const Banner = () => {
  ...
  return (
    <div className="bg-image relative px-10" id="home-section">
      ...
      <div className="mx-auto max-w-7xl pt-16 lg:pt-24 2xl:pt-40 sm:pb-24 px-6">
        <div className="height-work">
          <div className="grid grid-cols-1 lg:grid-cols-12 my-8">
            <div className="arrowTwo"></div>
            <div className="col-span-7">
              <h1 className="text-4xl lg:text-6xl 2xl:text-7xl font-bold mb-5 text-white md:4px md:text-start text-center">
